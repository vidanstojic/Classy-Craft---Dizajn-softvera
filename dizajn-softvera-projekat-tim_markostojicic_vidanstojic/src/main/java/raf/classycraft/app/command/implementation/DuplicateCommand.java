...
public class DuplicateCommand extends AbstractCommand {
    ...
    public DuplicateCommand(DiagramView diagramView, Interclass interclass, InterClassPainter interClassPainter, ClassyTreeItem parentTreeItem, ClassyTreeItem childTreeItem, ClassyTreeImplementation classyTreeImplementation) {
